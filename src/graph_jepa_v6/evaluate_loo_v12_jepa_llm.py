"""Compare the HF LOO JEPA baseline, Graph-JEPA v6, and an LLM on sampled LOO queries."""
...
DEFAULT_RAW_TEST_GRAPHS = "outputs/fawkes_raw_global_v6/test"
DEFAULT_V6_CHECKPOINT = "ckpts/fawkes_raw_v6/graph_jepa_v6.pt"
...
def _print_three_way(loo: dict, v6: dict, llm: dict) -> None:
    ...
    print(
        ...
        "LOO_MRR LOO_H@1  V6_MRR V6_H@1  LLM_MRR LLM_H@1"
    )
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "the HF LOO JEPA baseline, Graph-JEPA v6, and an LLM."
        )
    )
